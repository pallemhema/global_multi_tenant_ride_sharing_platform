...
//               className={`cursor-pointer w-full p-2 rounded border border-slate-300 bg-slate-50 text-slate-900" ${activeField === "pickup" ? "border-indigo-500" : ""}`}
//             />
...
//               className={`cursor-pointer w-full p-2 rounded border border-slate-300 bg-slate-50 text-slate-900 ${activeField === "drop" ? "border-indigo-500" : ""}`}
//             />
//           </div>
//         </div>
