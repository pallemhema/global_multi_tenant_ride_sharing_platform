...
export default function VehicleForm() {
  ...
  useEffect(() => {
    const load = async () => {
      setCategories(await lookupsAPI.getVehicleCategories());
  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full border border-gray-300 rounded px-4 py-2 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      />
      ...
      <select
        ...
        className="w-full border border-gray-300 rounded px-4 py-2 bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      >
