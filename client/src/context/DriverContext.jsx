...
// console.log("DriverContext runtimeStatus:", runtimeStatus?.runtime_status);
...
//       return res;
//     } catch (err) {
//       // Handle race condition: another driver already accepted
...
//       if (isRaceCondition) {
//         // Immediately remove this trip from the list
//         await loadTripRequests();
